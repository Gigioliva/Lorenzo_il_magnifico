...
public class AdaptiveLayout {
	...
	private Rectangle orangeDice;
	private Rectangle whiteDice;
	private Rectangle blackDice;
	private Rectangle councilPalaceButton;
	private Rectangle councilPalace;
	private Rectangle harvestLeftButton;
	private Rectangle harvestRightButton;
	private Rectangle harvestRightFam;
	private Rectangle harvestRightCover;
	private Rectangle productionLeftButton;
	private Rectangle productionRightButton;
	private Rectangle productionRightFam;
	private Rectangle productionRightCover;
	private Rectangle market1;
	private Rectangle market2;
	private Rectangle market3;
	private Rectangle market4;
	private Rectangle marketCover3;
	private Rectangle marketCover4;
	private Rectangle playerGrid;
	private Rectangle church1;
	private Rectangle church2;
	private Rectangle church3;
	private Rectangle faithSlotFrom1To3;
	private Rectangle faithSlotFrom3To5;
	private Rectangle faithSlotFrom6To15;
	private Rectangle victorySlot0;
	private Rectangle victorySlotFrom1To19;
	private Rectangle victorySlot20;
	private Rectangle victorySlotFrom21To49;
	private Rectangle victorySlot50;
	private Rectangle victorySlotFrom51To69;
	private Rectangle victorySlot70;
	private Rectangle victorySlotFrom71To99;
	private Rectangle familiar;
	private Rectangle militarySlotFrom1;
	private Rectangle militarySlot0;
	private Rectangle excommSlot1;
	private Rectangle excommSlot2;
	private Rectangle excommSlot3;
	private int cardDevelopmentStartOffsetX;
	private int cardDevelopmentStartOffsetY;
	private int cardDevelopmentHeight;
	private int cardDevelopmentWidth;
	private int cardDevelopmentOffsetX;
	private int cardDevelopmentOffsetY;
	private int playerGridOffsetY;
	private int inChurchOffsetX;
	private int outChurchOffsetX;
	private int victoryPointOffsetXY;
	private int familiarOffsetX;
	private int familiarOffsetY;
	private int militaryOffsetY;
	private int addingMilitaryOffsetY;
	...
	private AdaptiveLayout() {
		...
		harvestLeftButton = new Rectangle(195, 335, 3360, 3500);
		...
		productionLeftButton = new Rectangle(195, 335, 3050, 3190);
		...
		market1 = new Rectangle(1456, 1556, 3020, 3120);
		market2 = new Rectangle(1690, 1790, 3020, 3120);
		market3 = new Rectangle(1914, 2014, 3090, 3190);
		market4 = new Rectangle(2090, 2190, 3260, 3360);
		...
		faithSlotFrom1To3 = new Rectangle(169, 274, 2738, 2845);
		faithSlotFrom3To5 = new Rectangle(550, 657, 2738, 2845);
		faithSlotFrom6To15 = new Rectangle(1077, 1182, 2738, 2845);
		victorySlot0 = new Rectangle(50, 130, 35, 115);
		victorySlotFrom1To19 = new Rectangle(195, 275, 5, 85);
		victorySlot20 = new Rectangle(2520, 2600, 35, 115);
		victorySlotFrom21To49 = new Rectangle(2565, 2645, 170, 250);
		victorySlot50 = new Rectangle(2520, 2600, 3630, 3710);
		victorySlotFrom51To69 = new Rectangle(2370, 2450, 3660, 3740);
		victorySlot70 = new Rectangle(50, 130, 3630, 3710);
		victorySlotFrom71To99 = new Rectangle(5, 85, 3490, 3570);
		familiar = new Rectangle(512, 612, 360, 460);
		militarySlotFrom1 = new Rectangle(2300, 2380, 3240, 3320);
		militarySlot0 = new Rectangle(2300, 2380, 3400, 3480);
		excommSlot1 = new Rectangle(534, 654, 2328, 2448);
		excommSlot2 = new Rectangle(732, 852, 2360, 2480);
		excommSlot3 = new Rectangle(930, 1050, 2328, 2448);
