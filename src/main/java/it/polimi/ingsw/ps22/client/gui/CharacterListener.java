...
public class CharacterListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		TowerCharacterMove move = new TowerCharacterMove(pressedButton.getUsername(), pressedButton.getColor(), pressedButton.getFloor(), 
				pressedButton.getNumServants());
		System.out.println("creo character Move, color fam: " + pressedButton.getColor() +"  piano torre: " +   pressedButton.getFloor() + 
