...
public class LoginFrame extends JFrame {
	...
	public LoginFrame(ViewClient view){
		...
		JLabel allLabel = new JLabel(new ImageIcon("/Users/marco/git/Lorenzo_il_magnifico/src/main/java/it/polimi/ingsw/ps22/client/gui/image/persboardback.png"));
	...
	private class ConfirmListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if(confirm4.isSelected()){
				view.send(new AnswerUsername(userText.getText(), passText.getText(),4));
			}
			if(confirm5.isSelected()){
				view.send(new AnswerUsername(userText.getText(), passText.getText(),5));
			}
