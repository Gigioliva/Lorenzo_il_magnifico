...
public class PersonalBoardPanel extends JPanel {
	...
	public PersonalBoardPanel(double widthScreen, double heightScreen, String username, String pathPersonalBonus) {
		...
		Rectangle dimBonus = new Rectangle((int) (heightScreen * 0.71),
				(int) (personalBonus.getIconWidth() / factorScalePersonalBoard + heightScreen * 0.71), 0,
				(int) (personalBonus.getIconHeight() / factorScalePersonalBoard));
		...
		Rectangle dimBoard = new Rectangle((int) (heightScreen * 0.71) + personalBonus.getIconWidth(),
				(int) (personal.getIconWidth() / factorScalePersonalBoard + heightScreen * 0.71
						+ personalBonus.getIconWidth()),
				0, (int) (personal.getIconHeight() / factorScalePersonalBoard));
		...
		servantLabel.setBounds(dimServant.getInitx(), dimServant.getInity(), dimServant.getOffsetX(),
				dimServant.getOffsetY());
		...
		this.setBounds((int) (heightScreen * 0.71), 0,
				(int) ((personal.getIconWidth()) / factorScalePersonalBoard) + bonusLabel.getWidth(),
	...
	public void update(Model model) {
		...
		stoneLabel
				.setText((String.valueOf(model.getPlayers().get(username).getSpecificResource("Stone").getQuantity())));
		servantLabel.setText(
				(String.valueOf(model.getPlayers().get(username).getSpecificResource("Servant").getQuantity())));
