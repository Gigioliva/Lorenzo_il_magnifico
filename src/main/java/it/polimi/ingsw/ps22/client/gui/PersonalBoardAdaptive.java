...
public class PersonalBoardAdaptive {
	...
	public static Rectangle getOrangeButtonSLot(double resizeFactor) {
		Rectangle temp = new Rectangle(
				(blackDiceButtonSlot.getInitx()+diceButtonOffsetX),
				(blackDiceButtonSlot.getFinalx()+diceButtonOffsetX),
				blackDiceButtonSlot.getInity(),
	...
	public static Rectangle getWhiteButtonSLot(double resizeFactor) {
		Rectangle temp = new Rectangle(
				(blackDiceButtonSlot.getInitx()+(2*diceButtonOffsetX)),
				(blackDiceButtonSlot.getFinalx()+(2*diceButtonOffsetX)),
				blackDiceButtonSlot.getInity(),
				blackDiceButtonSlot.getFinaly());
		return temp.resize(resizeFactor);
	}
	...
	public static Rectangle getNeutralButtonSLot(double resizeFactor) {
		Rectangle temp = new Rectangle(
				(blackDiceButtonSlot.getInitx()+(3*diceButtonOffsetX)),
				(blackDiceButtonSlot.getFinalx()+(3*diceButtonOffsetX)),
				blackDiceButtonSlot.getInity(),
				blackDiceButtonSlot.getFinaly());
		return temp.resize(resizeFactor);
	}
	...
	/*			GIOCATORE 1			GIOCATORE 3			GIOCATORE 5
	 * 			GIOCATORE 2			GIOCATORE 4			ECC...
	 */
	...
	public static Rectangle getPlayerButtonSLot(double resizeFactor, int player) {
		...
		Rectangle temp = new Rectangle(
				(basicPlayerButtonSlot.getInitx()+((xMolt)*playerOffsetX)),
