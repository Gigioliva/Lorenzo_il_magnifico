...
/**
 * 
 * This class checks whether the {@link HarvestAction} class works properly or
 * not
 *
 */
...
public class TestHarvestAction {
	...
	/**
	 * This method initializes a {@link HarvestAction}, {@link Model} and
	 * {@link Player}
	 * 
	 */
	...
	/**
	 * this method tests the applyAction method in {@link HarvestAction}
	 */
	
	@Test
	public void testApplyAction() {
		action.applyAction(player, servants, model);
		assert (player.getSpecificResource("MilitaryPoint")
				.getQuantity() == player.getPersonalBoard().getPersonalBonus().get("Harvest").getGain()
						.get("MilitaryPoint").getQuantity() + 1
